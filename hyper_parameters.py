...
EPOCHS = 150 // AUGMENTATION_COUNT
CHARACTER_EMBEDDING_SIZE = 30
MAX_CHARACTERS = 15  # helps as padding for the CNN too!
FILTERS_NUMBER = 30
FILTER_SIZE = 3

CHAR_NER_LAYERS = [EMBEDDING_SIZE * WINDOW + WINDOW * FILTERS_NUMBER,
                   500,
                   len(NER_CLASS_TO_INDEX)]

CHAR_POS_LAYERS = [EMBEDDING_SIZE * WINDOW + WINDOW * FILTERS_NUMBER, 500,
                   len(POS_CLASS_TO_INDEX)]
